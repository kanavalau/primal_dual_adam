"The code is modified slightly from the native pytorch implementation to bring it in line with the algorithm as in S. Bock and M. Weiß. A Proof of Local Convergence for the Adam Optimizer. In 2019 International Joint Conference on Neural Networks (IJCNN), pages 1–8, 2019."
    ...
    for i, param in enumerate(params):
        ...
        if capturable:
            ...
            if amsgrad:
                ...
                denom = (exp_avg_sq.add_(eps).sqrt() / bias_correction2_sqrt)
